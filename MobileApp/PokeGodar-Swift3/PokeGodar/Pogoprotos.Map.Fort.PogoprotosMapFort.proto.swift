...
public extension Pogoprotos.Map.Fort {
  ...
  public enum FortRenderingType:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    public static func fromString(_ str:String) throws -> Pogoprotos.Map.Fort.FortRenderingType {
      switch str {
      case "DEFAULT":  return .default
  ...
  public enum FortSponsor:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    public static func fromString(_ str:String) throws -> Pogoprotos.Map.Fort.FortSponsor {
      switch str {
  ...
  public enum FortType:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    public static func fromString(_ str:String) throws -> Pogoprotos.Map.Fort.FortType {
      switch str {
      case "GYM":  return .gym
      case "CHECKPOINT":  return .checkpoint
      default: throw ProtocolBuffersError.InvalidProtocolBuffer("Conversion String to Enum has failed.")
  ...
  final public class FortData : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var activeFortModifier:Data = Data()
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Map.Fort.FortData> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortData? {
      return try Pogoprotos.Map.Fort.FortData.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Map.Fort.FortData {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortData {
      return try Pogoprotos.Map.Fort.FortData.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortData {
      return try Pogoprotos.Map.Fort.FortData.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortData {
      return try Pogoprotos.Map.Fort.FortData.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortData {
      return try Pogoprotos.Map.Fort.FortData.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortData {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Map.Fort.FortData) throws -> Pogoprotos.Map.Fort.FortData.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if hasActiveFortModifier {
        jsonMap["activeFortModifier"] = activeFortModifier.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
      }
      if hasLureInfo {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortData {
      return try Pogoprotos.Map.Fort.FortData.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Map.Fort.FortData {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func clearEnabled() -> Pogoprotos.Map.Fort.FortData.Builder{
        ...
        public func setTypes(_ value:Pogoprotos.Map.Fort.FortType) -> Pogoprotos.Map.Fort.FortData.Builder {
          self.types = value
          return self
        }
      ...
      public var activeFortModifier:Data {
           get {
      ...
      public func setActiveFortModifier(_ value:Data) -> Pogoprotos.Map.Fort.FortData.Builder {
      ...
      public func clearActiveFortModifier() -> Pogoprotos.Map.Fort.FortData.Builder{
           ...
           builderResult.activeFortModifier = Data()
           return self
      }
      ...
      public func mergeLureInfo(_ value:Pogoprotos.Map.Fort.FortLureInfo) throws -> Pogoprotos.Map.Fort.FortData.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Map.Fort.FortData) throws -> Pogoprotos.Map.Fort.FortData.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortData.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortData.Builder {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortData.Builder {
        ...
        if let jsonValueActiveFortModifier = jsonMap["activeFortModifier"] as? String {
          resultDecodedBuilder.activeFortModifier = Data(base64EncodedString:jsonValueActiveFortModifier, options: NSData.Base64DecodingOptions(rawValue:0))!
        }
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Map.Fort.FortData.Builder {
  ...
  final public class FortLureInfo : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Map.Fort.FortLureInfo> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortLureInfo? {
      return try Pogoprotos.Map.Fort.FortLureInfo.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Map.Fort.FortLureInfo {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortLureInfo {
      return try Pogoprotos.Map.Fort.FortLureInfo.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortLureInfo {
      return try Pogoprotos.Map.Fort.FortLureInfo.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortLureInfo {
      return try Pogoprotos.Map.Fort.FortLureInfo.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortLureInfo {
      return try Pogoprotos.Map.Fort.FortLureInfo.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortLureInfo {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Map.Fort.FortLureInfo) throws -> Pogoprotos.Map.Fort.FortLureInfo.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortLureInfo {
      return try Pogoprotos.Map.Fort.FortLureInfo.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Map.Fort.FortLureInfo {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Map.Fort.FortLureInfo) throws -> Pogoprotos.Map.Fort.FortLureInfo.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortLureInfo.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortLureInfo.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortLureInfo.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Map.Fort.FortLureInfo.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class FortModifier : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Map.Fort.FortModifier> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortModifier? {
      return try Pogoprotos.Map.Fort.FortModifier.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Map.Fort.FortModifier {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortModifier {
      return try Pogoprotos.Map.Fort.FortModifier.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortModifier {
      return try Pogoprotos.Map.Fort.FortModifier.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortModifier {
      return try Pogoprotos.Map.Fort.FortModifier.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortModifier {
      return try Pogoprotos.Map.Fort.FortModifier.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortModifier {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Map.Fort.FortModifier) throws -> Pogoprotos.Map.Fort.FortModifier.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortModifier {
      return try Pogoprotos.Map.Fort.FortModifier.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Map.Fort.FortModifier {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      required override public init () {
        ...
        public func setItemId(_ value:Pogoprotos.Inventory.ItemId) -> Pogoprotos.Map.Fort.FortModifier.Builder {
          self.itemId = value
          return self
        }
      ...
      public func mergeFrom(_ other:Pogoprotos.Map.Fort.FortModifier) throws -> Pogoprotos.Map.Fort.FortModifier.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortModifier.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortModifier.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortModifier.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Map.Fort.FortModifier.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class FortSummary : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Map.Fort.FortSummary> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortSummary? {
      return try Pogoprotos.Map.Fort.FortSummary.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Map.Fort.FortSummary {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortSummary {
      return try Pogoprotos.Map.Fort.FortSummary.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.Fort.FortSummary {
      return try Pogoprotos.Map.Fort.FortSummary.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortSummary {
      return try Pogoprotos.Map.Fort.FortSummary.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortSummary {
      return try Pogoprotos.Map.Fort.FortSummary.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortSummary {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Map.Fort.FortSummary) throws -> Pogoprotos.Map.Fort.FortSummary.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      var jsonMap:Dictionary<String,AnyObject> = Dictionary<String,AnyObject>()
      if hasFortSummaryId {
        jsonMap["fortSummaryId"] = NSNumber(value:fortSummaryId)
      }
      if hasLastModifiedTimestampMs {
        jsonMap["lastModifiedTimestampMs"] = NSNumber(value:lastModifiedTimestampMs)
      }
      if hasLatitude {
        jsonMap["latitude"] = NSNumber(value:latitude)
      }
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortSummary {
      return try Pogoprotos.Map.Fort.FortSummary.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Map.Fort.FortSummary {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setFortSummaryId(_ value:Int32) -> Pogoprotos.Map.Fort.FortSummary.Builder {
      ...
      public func setLastModifiedTimestampMs(_ value:Int32) -> Pogoprotos.Map.Fort.FortSummary.Builder {
        self.lastModifiedTimestampMs = value
        return self
      }
      ...
      public func setLatitude(_ value:Int32) -> Pogoprotos.Map.Fort.FortSummary.Builder {
        self.latitude = value
        return self
      }
      ...
      public func setLongitude(_ value:Int32) -> Pogoprotos.Map.Fort.FortSummary.Builder {
        self.longitude = value
        return self
      }
      ...
      public func mergeFrom(_ other:Pogoprotos.Map.Fort.FortSummary) throws -> Pogoprotos.Map.Fort.FortSummary.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.Fort.FortSummary.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.Fort.FortSummary.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.Fort.FortSummary.Builder {
        ...
        if let jsonValueFortSummaryId = jsonMap["fortSummaryId"] as? NSNumber {
          resultDecodedBuilder.fortSummaryId = jsonValueFortSummaryId.int32Value
        }
        if let jsonValueLastModifiedTimestampMs = jsonMap["lastModifiedTimestampMs"] as? NSNumber {
          resultDecodedBuilder.lastModifiedTimestampMs = jsonValueLastModifiedTimestampMs.int32Value
        }
        if let jsonValueLatitude = jsonMap["latitude"] as? NSNumber {
          resultDecodedBuilder.latitude = jsonValueLatitude.int32Value
        }
        if let jsonValueLongitude = jsonMap["longitude"] as? NSNumber {
          resultDecodedBuilder.longitude = jsonValueLongitude.int32Value
        }
        return resultDecodedBuilder
      }
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Map.Fort.FortSummary.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
