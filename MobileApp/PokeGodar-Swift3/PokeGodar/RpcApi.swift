...
class RpcApi {
    ...
    private func parseMainResponse(_ data: Data) -> ApiResponse {
    ...
    private func parseSubResponses(_ response: Pogoprotos.Networking.Envelopes.ResponseEnvelope) -> [GeneratedMessage] {
