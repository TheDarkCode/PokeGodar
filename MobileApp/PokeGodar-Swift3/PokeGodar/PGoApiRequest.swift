...
struct ApiMethod {
    ...
    let parser: (Data) -> GeneratedMessage
}
...
class PGoApiRequest {
    ...
    func makeRequest(_ intent: ApiIntent, delegate: PGoApiDelegate?) {  // analogous to call in pgoapi.py
    ...
    func getMapObjects(_ latitude: Double, longitude: Double) {
