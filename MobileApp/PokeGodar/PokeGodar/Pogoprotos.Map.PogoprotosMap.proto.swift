...
public extension Pogoprotos.Map {
  ...
  public enum MapObjectsStatus:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    public static func fromString(_ str:String) throws -> Pogoprotos.Map.MapObjectsStatus {
      switch str {
  ...
  final public class MapCell : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Map.MapCell> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.MapCell? {
      return try Pogoprotos.Map.MapCell.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Map.MapCell {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.MapCell {
      return try Pogoprotos.Map.MapCell.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.MapCell {
      return try Pogoprotos.Map.MapCell.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.MapCell {
      return try Pogoprotos.Map.MapCell.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.MapCell {
      return try Pogoprotos.Map.MapCell.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.MapCell {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Map.MapCell) throws -> Pogoprotos.Map.MapCell.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.MapCell {
      return try Pogoprotos.Map.MapCell.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Map.MapCell {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Map.MapCell) throws -> Pogoprotos.Map.MapCell.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.MapCell.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.MapCell.Builder {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.MapCell.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Map.MapCell.Builder {
  ...
  final public class SpawnPoint : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Map.SpawnPoint> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.SpawnPoint? {
      return try Pogoprotos.Map.SpawnPoint.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Map.SpawnPoint {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.SpawnPoint {
      return try Pogoprotos.Map.SpawnPoint.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Map.SpawnPoint {
      return try Pogoprotos.Map.SpawnPoint.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.SpawnPoint {
      return try Pogoprotos.Map.SpawnPoint.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.SpawnPoint {
      return try Pogoprotos.Map.SpawnPoint.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.SpawnPoint {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Map.SpawnPoint) throws -> Pogoprotos.Map.SpawnPoint.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.SpawnPoint {
      return try Pogoprotos.Map.SpawnPoint.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Map.SpawnPoint {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Map.SpawnPoint) throws -> Pogoprotos.Map.SpawnPoint.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Map.SpawnPoint.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Map.SpawnPoint.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Map.SpawnPoint.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Map.SpawnPoint.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
