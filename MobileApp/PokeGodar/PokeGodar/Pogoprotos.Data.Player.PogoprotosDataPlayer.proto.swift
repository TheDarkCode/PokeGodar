...
public extension Pogoprotos.Data.Player {
  ...
  final public class ContactSettings : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.ContactSettings> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.ContactSettings? {
      return try Pogoprotos.Data.Player.ContactSettings.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.ContactSettings {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.ContactSettings {
      return try Pogoprotos.Data.Player.ContactSettings.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.ContactSettings {
      return try Pogoprotos.Data.Player.ContactSettings.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.ContactSettings {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.ContactSettings {
      return try Pogoprotos.Data.Player.ContactSettings.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.ContactSettings {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.ContactSettings) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.ContactSettings {
      return try Pogoprotos.Data.Player.ContactSettings.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.ContactSettings {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.ContactSettings) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
  ...
  final public class Currency : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.Currency> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.Currency? {
      return try Pogoprotos.Data.Player.Currency.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.Currency {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.Currency {
      return try Pogoprotos.Data.Player.Currency.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.Currency {
      return try Pogoprotos.Data.Player.Currency.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.Currency {
      return try Pogoprotos.Data.Player.Currency.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.Currency {
      return try Pogoprotos.Data.Player.Currency.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.Currency {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.Currency) throws -> Pogoprotos.Data.Player.Currency.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.Currency {
      return try Pogoprotos.Data.Player.Currency.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.Currency {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.Currency) throws -> Pogoprotos.Data.Player.Currency.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.Currency.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.Currency.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.Currency.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.Currency.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class DailyBonus : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.DailyBonus> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.DailyBonus? {
      return try Pogoprotos.Data.Player.DailyBonus.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.DailyBonus {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.DailyBonus {
      return try Pogoprotos.Data.Player.DailyBonus.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.DailyBonus {
      return try Pogoprotos.Data.Player.DailyBonus.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.DailyBonus {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.DailyBonus {
      return try Pogoprotos.Data.Player.DailyBonus.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.DailyBonus {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.DailyBonus) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.DailyBonus {
      return try Pogoprotos.Data.Player.DailyBonus.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.DailyBonus {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.DailyBonus) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class EquippedBadge : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.EquippedBadge> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.EquippedBadge? {
      return try Pogoprotos.Data.Player.EquippedBadge.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.EquippedBadge {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.EquippedBadge {
      return try Pogoprotos.Data.Player.EquippedBadge.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.EquippedBadge {
      return try Pogoprotos.Data.Player.EquippedBadge.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.EquippedBadge {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.EquippedBadge {
      return try Pogoprotos.Data.Player.EquippedBadge.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.EquippedBadge {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.EquippedBadge) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.EquippedBadge {
      return try Pogoprotos.Data.Player.EquippedBadge.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.EquippedBadge {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.EquippedBadge) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerAvatar : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.PlayerAvatar> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerAvatar? {
      return try Pogoprotos.Data.Player.PlayerAvatar.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerAvatar {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerAvatar {
      return try Pogoprotos.Data.Player.PlayerAvatar.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerAvatar {
      return try Pogoprotos.Data.Player.PlayerAvatar.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerAvatar {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerAvatar {
      return try Pogoprotos.Data.Player.PlayerAvatar.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerAvatar {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.PlayerAvatar) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerAvatar {
      return try Pogoprotos.Data.Player.PlayerAvatar.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerAvatar {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.PlayerAvatar) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerCamera : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.PlayerCamera> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerCamera? {
      return try Pogoprotos.Data.Player.PlayerCamera.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerCamera {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCamera {
      return try Pogoprotos.Data.Player.PlayerCamera.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerCamera {
      return try Pogoprotos.Data.Player.PlayerCamera.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCamera {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerCamera {
      return try Pogoprotos.Data.Player.PlayerCamera.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCamera {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.PlayerCamera) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerCamera {
      return try Pogoprotos.Data.Player.PlayerCamera.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerCamera {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.PlayerCamera) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerCurrency : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.PlayerCurrency> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerCurrency? {
      return try Pogoprotos.Data.Player.PlayerCurrency.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerCurrency {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCurrency {
      return try Pogoprotos.Data.Player.PlayerCurrency.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerCurrency {
      return try Pogoprotos.Data.Player.PlayerCurrency.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCurrency {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerCurrency {
      return try Pogoprotos.Data.Player.PlayerCurrency.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCurrency {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.PlayerCurrency) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerCurrency {
      return try Pogoprotos.Data.Player.PlayerCurrency.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerCurrency {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.PlayerCurrency) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerPublicProfile : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.PlayerPublicProfile> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerPublicProfile? {
      return try Pogoprotos.Data.Player.PlayerPublicProfile.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
    ...
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
      return try Pogoprotos.Data.Player.PlayerPublicProfile.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
      return try Pogoprotos.Data.Player.PlayerPublicProfile.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.PlayerPublicProfile) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
      return try Pogoprotos.Data.Player.PlayerPublicProfile.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerPublicProfile {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeAvatar(_ value:Pogoprotos.Data.Player.PlayerAvatar) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.PlayerPublicProfile) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerStats : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var pokemonCaughtByType:Data = Data()
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Player.PlayerStats> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerStats? {
      return try Pogoprotos.Data.Player.PlayerStats.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerStats {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerStats {
      return try Pogoprotos.Data.Player.PlayerStats.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Player.PlayerStats {
      return try Pogoprotos.Data.Player.PlayerStats.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerStats {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerStats {
      return try Pogoprotos.Data.Player.PlayerStats.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerStats {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Player.PlayerStats) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if hasPokemonCaughtByType {
        jsonMap["pokemonCaughtByType"] = pokemonCaughtByType.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
      }
      if hasSmallRattataCaught {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerStats {
      return try Pogoprotos.Data.Player.PlayerStats.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerStats {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public var pokemonCaughtByType:Data {
           get {
      ...
      public func setPokemonCaughtByType(_ value:Data) -> Pogoprotos.Data.Player.PlayerStats.Builder {
      ...
      public func clearPokemonCaughtByType() -> Pogoprotos.Data.Player.PlayerStats.Builder{
           ...
           builderResult.pokemonCaughtByType = Data()
           return self
      }
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Player.PlayerStats) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
        ...
        if let jsonValuePokemonCaughtByType = jsonMap["pokemonCaughtByType"] as? String {
          resultDecodedBuilder.pokemonCaughtByType = Data(base64EncodedString:jsonValuePokemonCaughtByType, options: NSData.Base64DecodingOptions(rawValue:0))!
        }
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
