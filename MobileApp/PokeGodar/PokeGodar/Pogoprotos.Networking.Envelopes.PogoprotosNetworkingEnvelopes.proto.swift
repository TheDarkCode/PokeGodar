...
public extension Pogoprotos.Networking.Envelopes {
  ...
  final public class AuthTicket : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var start:Data = Data()
    ...
    public private(set) var end:Data = Data()
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.AuthTicket> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.AuthTicket? {
      return try Pogoprotos.Networking.Envelopes.AuthTicket.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
    ...
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
      return try Pogoprotos.Networking.Envelopes.AuthTicket.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
      return try Pogoprotos.Networking.Envelopes.AuthTicket.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.AuthTicket) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if hasStart {
        jsonMap["start"] = start.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
      }
      if hasExpireTimestampMs {
        jsonMap["expireTimestampMs"] = "\(expireTimestampMs)"
      }
      if hasEnd {
        jsonMap["end"] = end.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
      }
      return jsonMap
    }
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
      return try Pogoprotos.Networking.Envelopes.AuthTicket.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.AuthTicket {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.AuthTicket) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
        let resultDecodedBuilder = Pogoprotos.Networking.Envelopes.AuthTicket.Builder()
        if let jsonValueStart = jsonMap["start"] as? String {
          resultDecodedBuilder.start = Data(base64EncodedString:jsonValueStart, options: NSData.Base64DecodingOptions(rawValue:0))!
        }
        ...
        if let jsonValueEnd = jsonMap["end"] as? String {
          resultDecodedBuilder.end = Data(base64EncodedString:jsonValueEnd, options: NSData.Base64DecodingOptions(rawValue:0))!
        }
        return resultDecodedBuilder
      }
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
  ...
  final public class RequestEnvelope : GeneratedMessage, GeneratedMessageProtocol {
      ...
      final public class AuthInfo : GeneratedMessage, GeneratedMessageProtocol {
        ...
        //Nested type declaration start
          ...
          final public class Jwt : GeneratedMessage, GeneratedMessageProtocol {
            ...
            public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt> {
            ...
            public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt? {
            ...
            public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
            ...
            public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
            ...
            public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
              return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder().mergeFromInputStream(input).build()
            }
            public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
            ...
            public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
              return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder().mergeFromCodedInputStream(input).build()
            }
            public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
            ...
            public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
            ...
            override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
              return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder.decodeToBuilder(jsonMap).build()
            }
            override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt {
            ...
            final public class Builder : GeneratedMessageBuilder {
              ...
              public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
              ...
              override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
                   return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
              }
              override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
                let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
                while (true) {
                  let protobufTag = try input.readTag()
                  switch protobufTag {
              ...
              override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
              ...
              override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
                let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
                guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
                  throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
                }
        ...
        public private(set) var token:;.Jwt!
        required public init() {
             super.init()
        }
        override public func isInitialized() -> Bool {
        ...
        public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo> {
        ...
        public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo? {
          return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder().mergeDelimitedFromInputStream(input)?.build()
        }
        public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
        ...
        public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
        ...
        public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
          return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder().mergeFromInputStream(input).build()
        }
        public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
        ...
        public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
          return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder().mergeFromCodedInputStream(input).build()
        }
        public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
        ...
        public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
        ...
        override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
          return try Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder.decodeToBuilder(jsonMap).build()
        }
        override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          public func mergeToken(_ value:Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
          ...
          public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
          ...
          override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
               return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
          }
          override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
            while (true) {
              let protobufTag = try input.readTag()
              switch protobufTag {
          ...
          override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
          ...
          override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
            let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
              throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
            }
    ...
    public private(set) var authInfo:;.AuthInfo!
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.RequestEnvelope> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope? {
      return try Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
    ...
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
      return try Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
      return try Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.RequestEnvelope) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
      return try Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setUnknown6(_ value:Pogoprotos.Networking.Envelopes.Unknown6!) -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
        self.unknown6 = value
        return self
      }
      public func mergeUnknown6(_ value:Pogoprotos.Networking.Envelopes.Unknown6) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
      ...
      public func setAltitude(_ value:Double) -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
        self.altitude = value
        return self
      }
      ...
      public func mergeAuthInfo(_ value:Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
      ...
      public func mergeAuthTicket(_ value:Pogoprotos.Networking.Envelopes.AuthTicket) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
      ...
      public func setUnknown12(_ value:Int64) -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.RequestEnvelope) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class ResponseEnvelope : GeneratedMessage, GeneratedMessageProtocol {
    ...
    //Nested type declaration start
      ...
      final public class Unknown7 : GeneratedMessage, GeneratedMessageProtocol {
        ...
        public private(set) var unknown71:Data = Data()
        ...
        public private(set) var unknown73:Data = Data()
        ...
        public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7> {
        ...
        public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7? {
          return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder().mergeDelimitedFromInputStream(input)?.build()
        }
        public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
        ...
        public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
        ...
        public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
          return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder().mergeFromInputStream(input).build()
        }
        public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
        ...
        public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
          return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder().mergeFromCodedInputStream(input).build()
        }
        public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
        ...
        public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
        ...
        override public func encode() throws -> Dictionary<String,AnyObject> {
          ...
          var jsonMap:Dictionary<String,AnyObject> = Dictionary<String,AnyObject>()
          if hasUnknown71 {
            jsonMap["unknown71"] = unknown71.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
          }
          if hasUnknown72 {
            jsonMap["unknown72"] = "\(unknown72)"
          }
          if hasUnknown73 {
            jsonMap["unknown73"] = unknown73.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
          }
          return jsonMap
        }
        override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
          return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder.decodeToBuilder(jsonMap).build()
        }
        override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7 {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          public func setUnknown71(_ value:Data) -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
          ...
          public func setUnknown72(_ value:Int64) -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
          ...
          public func setUnknown73(_ value:Data) -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
          ...
          public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
          ...
          override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
               return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
          }
          override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
            while (true) {
              let protobufTag = try input.readTag()
              switch protobufTag {
          ...
          override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
            ...
            if let jsonValueUnknown71 = jsonMap["unknown71"] as? String {
              resultDecodedBuilder.unknown71 = Data(base64EncodedString:jsonValueUnknown71, options: NSData.Base64DecodingOptions(rawValue:0))!
            }
            ...
            if let jsonValueUnknown73 = jsonMap["unknown73"] as? String {
              resultDecodedBuilder.unknown73 = Data(base64EncodedString:jsonValueUnknown73, options: NSData.Base64DecodingOptions(rawValue:0))!
            }
            return resultDecodedBuilder
          }
          override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Unknown7.Builder {
            let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
              throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
            }
    ...
    public private(set) var hasAuthTicket:Bool = false
    public private(set) var authTicket:Pogoprotos.Networking.Envelopes.AuthTicket!
    public private(set) var returns:Array<Data> = Array<Data>()
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.ResponseEnvelope> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope? {
      return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
    ...
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
      return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
      return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.ResponseEnvelope) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if !returns.isEmpty {
        var jsonArrayReturns:Array<String> = []
          for oneValueReturns in returns {
            jsonArrayReturns += [oneValueReturns.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))]
          }
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
      return try Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setStatusCode(_ value:Int32) -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        self.statusCode = value
        return self
      }
      ...
      public func setUnknown6(_ value:Pogoprotos.Networking.Envelopes.Unknown6Response!) -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        self.unknown6 = value
        return self
      }
      public func mergeUnknown6(_ value:Pogoprotos.Networking.Envelopes.Unknown6Response) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        if builderResult.hasUnknown6 {
      ...
      public func mergeAuthTicket(_ value:Pogoprotos.Networking.Envelopes.AuthTicket) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        if builderResult.hasAuthTicket {
          builderResult.authTicket = try Pogoprotos.Networking.Envelopes.AuthTicket.builderWithPrototype(builderResult.authTicket).mergeFrom(value).buildPartial()
        } else {
          builderResult.authTicket = value
      ...
      public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.ResponseEnvelope) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        ...
        if let jsonValueReturns = jsonMap["returns"] as? Array<String> {
          ...
          for oneValueReturns in jsonValueReturns {
            jsonArrayReturns += [Data(base64Encoded:oneValueReturns, options: NSData.Base64DecodingOptions(rawValue:0))!]
          }
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class Unknown6 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    //Nested type declaration start
      ...
      final public class Unknown2 : GeneratedMessage, GeneratedMessageProtocol {
        ...
        public private(set) var unknown1:Data = Data()
        ...
        public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.Unknown6.Unknown2> {
        ...
        public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2? {
          return try Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder().mergeDelimitedFromInputStream(input)?.build()
        }
        public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
        ...
        public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
        ...
        public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
          return try Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder().mergeFromInputStream(input).build()
        }
        public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
        ...
        public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
          return try Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder().mergeFromCodedInputStream(input).build()
        }
        public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
        ...
        public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.Unknown6.Unknown2) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
        ...
        override public func encode() throws -> Dictionary<String,AnyObject> {
          ...
          var jsonMap:Dictionary<String,AnyObject> = Dictionary<String,AnyObject>()
          if hasUnknown1 {
            jsonMap["unknown1"] = unknown1.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
          }
          return jsonMap
        }
        override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
          return try Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder.decodeToBuilder(jsonMap).build()
        }
        override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2 {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          public func setUnknown1(_ value:Data) -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
            self.unknown1 = value
            return self
          }
          public func clearUnknown1() -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder{
               builderResult.hasUnknown1 = false
               builderResult.unknown1 = Data()
               return self
          }
          override public var internalGetResult:GeneratedMessage {
               get {
          ...
          public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.Unknown6.Unknown2) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
          ...
          override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
               return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
          }
          override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
            while (true) {
              let protobufTag = try input.readTag()
              switch protobufTag {
          ...
          override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
            ...
            if let jsonValueUnknown1 = jsonMap["unknown1"] as? String {
              resultDecodedBuilder.unknown1 = Data(base64EncodedString:jsonValueUnknown1, options: NSData.Base64DecodingOptions(rawValue:0))!
            }
            return resultDecodedBuilder
          }
          override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Unknown2.Builder {
            let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
              throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
            }
    ...
    public private(set) var hasUnknown2:Bool = false
    public private(set) var unknown2:;.Unknown2!
    required public init() {
         super.init()
    }
    override public func isInitialized() -> Bool {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.Unknown6> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6? {
      return try Pogoprotos.Networking.Envelopes.Unknown6.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
      return try Pogoprotos.Networking.Envelopes.Unknown6.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
      return try Pogoprotos.Networking.Envelopes.Unknown6.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
      return try Pogoprotos.Networking.Envelopes.Unknown6.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.Unknown6) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      var jsonMap:Dictionary<String,AnyObject> = Dictionary<String,AnyObject>()
      if hasUnknown1 {
        jsonMap["unknown1"] = NSNumber(value:unknown1)
      }
      if hasUnknown2 {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
      return try Pogoprotos.Networking.Envelopes.Unknown6.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6 {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setUnknown1(_ value:Int32) -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
        self.unknown1 = value
        return self
      }
      ...
      public func setUnknown2(_ value:Pogoprotos.Networking.Envelopes.Unknown6.Unknown2!) -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
        self.unknown2 = value
        return self
      }
      public func mergeUnknown2(_ value:Pogoprotos.Networking.Envelopes.Unknown6.Unknown2) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.Unknown6) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
        ...
        if let jsonValueUnknown1 = jsonMap["unknown1"] as? NSNumber {
          resultDecodedBuilder.unknown1 = jsonValueUnknown1.int32Value
        }
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class Unknown6Response : GeneratedMessage, GeneratedMessageProtocol {
    ...
    //Nested type declaration start
      ...
      final public class Unknown2 : GeneratedMessage, GeneratedMessageProtocol {
        ...
        public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2> {
        ...
        public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2? {
          return try Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder().mergeDelimitedFromInputStream(input)?.build()
        }
        public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
        ...
        public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
        ...
        public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
          return try Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder().mergeFromInputStream(input).build()
        }
        public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
        ...
        public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
          return try Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder().mergeFromCodedInputStream(input).build()
        }
        public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
        ...
        public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
        ...
        override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
          return try Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder.decodeToBuilder(jsonMap).build()
        }
        override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2 {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          public func setUnknown1(_ value:UInt64) -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
            self.unknown1 = value
            return self
          }
          ...
          public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
          ...
          override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
               return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
          }
          override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
            while (true) {
              let protobufTag = try input.readTag()
              switch protobufTag {
          ...
          override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
          ...
          override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2.Builder {
            let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
              throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
            }
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Networking.Envelopes.Unknown6Response> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response? {
      return try Pogoprotos.Networking.Envelopes.Unknown6Response.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
    ...
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
      return try Pogoprotos.Networking.Envelopes.Unknown6Response.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
      return try Pogoprotos.Networking.Envelopes.Unknown6Response.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Networking.Envelopes.Unknown6Response) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
      return try Pogoprotos.Networking.Envelopes.Unknown6Response.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setUnknown1(_ value:Int32) -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
        self.unknown1 = value
        return self
      }
      ...
      public func setUnknown2(_ value:Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2!) -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
        self.unknown2 = value
        return self
      }
      public func mergeUnknown2(_ value:Pogoprotos.Networking.Envelopes.Unknown6Response.Unknown2) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
        if builderResult.hasUnknown2 {
      ...
      public func mergeFrom(_ other:Pogoprotos.Networking.Envelopes.Unknown6Response) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Networking.Envelopes.Unknown6Response.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
