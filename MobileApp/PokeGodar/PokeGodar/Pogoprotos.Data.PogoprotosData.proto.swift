...
public extension Pogoprotos.Data {
  ...
  final public class AssetDigestEntry : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var key:Data = Data()
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.AssetDigestEntry> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.AssetDigestEntry? {
      return try Pogoprotos.Data.AssetDigestEntry.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.AssetDigestEntry {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.AssetDigestEntry {
      return try Pogoprotos.Data.AssetDigestEntry.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.AssetDigestEntry {
      return try Pogoprotos.Data.AssetDigestEntry.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.AssetDigestEntry {
      return try Pogoprotos.Data.AssetDigestEntry.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.AssetDigestEntry {
      return try Pogoprotos.Data.AssetDigestEntry.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.AssetDigestEntry {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.AssetDigestEntry) throws -> Pogoprotos.Data.AssetDigestEntry.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if hasKey {
        jsonMap["key"] = key.base64EncodedString(NSData.Base64EncodingOptions(rawValue: 0))
      }
      return jsonMap
    }
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.AssetDigestEntry {
      return try Pogoprotos.Data.AssetDigestEntry.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.AssetDigestEntry {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.AssetDigestEntry) throws -> Pogoprotos.Data.AssetDigestEntry.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.AssetDigestEntry.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.AssetDigestEntry.Builder {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.AssetDigestEntry.Builder {
        ...
        if let jsonValueKey = jsonMap["key"] as? String {
          resultDecodedBuilder.key = Data(base64EncodedString:jsonValueKey, options: NSData.Base64DecodingOptions(rawValue:0))!
        }
        return resultDecodedBuilder
      }
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.AssetDigestEntry.Builder {
  ...
  final public class DownloadUrlEntry : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.DownloadUrlEntry> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.DownloadUrlEntry? {
      return try Pogoprotos.Data.DownloadUrlEntry.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.DownloadUrlEntry {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.DownloadUrlEntry {
      return try Pogoprotos.Data.DownloadUrlEntry.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.DownloadUrlEntry {
      return try Pogoprotos.Data.DownloadUrlEntry.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.DownloadUrlEntry {
      return try Pogoprotos.Data.DownloadUrlEntry.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.DownloadUrlEntry {
      return try Pogoprotos.Data.DownloadUrlEntry.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.DownloadUrlEntry {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.DownloadUrlEntry) throws -> Pogoprotos.Data.DownloadUrlEntry.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.DownloadUrlEntry {
      return try Pogoprotos.Data.DownloadUrlEntry.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.DownloadUrlEntry {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.DownloadUrlEntry) throws -> Pogoprotos.Data.DownloadUrlEntry.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.DownloadUrlEntry.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.DownloadUrlEntry.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.DownloadUrlEntry.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.DownloadUrlEntry.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerBadge : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.PlayerBadge> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PlayerBadge? {
      return try Pogoprotos.Data.PlayerBadge.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.PlayerBadge {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerBadge {
      return try Pogoprotos.Data.PlayerBadge.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PlayerBadge {
      return try Pogoprotos.Data.PlayerBadge.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerBadge {
      return try Pogoprotos.Data.PlayerBadge.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PlayerBadge {
      return try Pogoprotos.Data.PlayerBadge.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerBadge {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.PlayerBadge) throws -> Pogoprotos.Data.PlayerBadge.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PlayerBadge {
      return try Pogoprotos.Data.PlayerBadge.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.PlayerBadge {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.PlayerBadge) throws -> Pogoprotos.Data.PlayerBadge.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PlayerBadge.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerBadge.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PlayerBadge.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.PlayerBadge.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PlayerData : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.PlayerData> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PlayerData? {
      return try Pogoprotos.Data.PlayerData.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.PlayerData {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerData {
      return try Pogoprotos.Data.PlayerData.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PlayerData {
      return try Pogoprotos.Data.PlayerData.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerData {
      return try Pogoprotos.Data.PlayerData.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PlayerData {
      return try Pogoprotos.Data.PlayerData.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerData {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.PlayerData) throws -> Pogoprotos.Data.PlayerData.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if hasTeam {
        jsonMap["team"] = NSNumber(value:team)
      }
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PlayerData {
      return try Pogoprotos.Data.PlayerData.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.PlayerData {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setTeam(_ value:Int32) -> Pogoprotos.Data.PlayerData.Builder {
        self.team = value
        return self
      }
      ...
      public func mergeAvatar(_ value:Pogoprotos.Data.Player.PlayerAvatar) throws -> Pogoprotos.Data.PlayerData.Builder {
      ...
      public func mergeDailyBonus(_ value:Pogoprotos.Data.Player.DailyBonus) throws -> Pogoprotos.Data.PlayerData.Builder {
      ...
      public func mergeEquippedBadge(_ value:Pogoprotos.Data.Player.EquippedBadge) throws -> Pogoprotos.Data.PlayerData.Builder {
      ...
      public func mergeContactSettings(_ value:Pogoprotos.Data.Player.ContactSettings) throws -> Pogoprotos.Data.PlayerData.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.PlayerData) throws -> Pogoprotos.Data.PlayerData.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PlayerData.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PlayerData.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PlayerData.Builder {
        ...
        if let jsonValueTeam = jsonMap["team"] as? NSNumber {
          resultDecodedBuilder.team = jsonValueTeam.int32Value
        }
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.PlayerData.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PokedexEntry : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.PokedexEntry> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PokedexEntry? {
      return try Pogoprotos.Data.PokedexEntry.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.PokedexEntry {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokedexEntry {
      return try Pogoprotos.Data.PokedexEntry.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PokedexEntry {
      return try Pogoprotos.Data.PokedexEntry.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokedexEntry {
      return try Pogoprotos.Data.PokedexEntry.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PokedexEntry {
      return try Pogoprotos.Data.PokedexEntry.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokedexEntry {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.PokedexEntry) throws -> Pogoprotos.Data.PokedexEntry.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PokedexEntry {
      return try Pogoprotos.Data.PokedexEntry.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.PokedexEntry {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.PokedexEntry) throws -> Pogoprotos.Data.PokedexEntry.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PokedexEntry.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokedexEntry.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PokedexEntry.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.PokedexEntry.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
  ...
  final public class PokemonData : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.PokemonData> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PokemonData? {
      return try Pogoprotos.Data.PokemonData.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.PokemonData {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokemonData {
      return try Pogoprotos.Data.PokemonData.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.PokemonData {
      return try Pogoprotos.Data.PokemonData.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokemonData {
      return try Pogoprotos.Data.PokemonData.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PokemonData {
      return try Pogoprotos.Data.PokemonData.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokemonData {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.PokemonData) throws -> Pogoprotos.Data.PokemonData.Builder {
    ...
    override public func encode() throws -> Dictionary<String,AnyObject> {
      ...
      if hasDeployedFortId {
        jsonMap["deployedFortId"] = NSNumber(value:deployedFortId)
      }
      if hasOwnerName {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PokemonData {
      return try Pogoprotos.Data.PokemonData.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.PokemonData {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setDeployedFortId(_ value:Int32) -> Pogoprotos.Data.PokemonData.Builder {
      ...
      public func setPokeball(_ value:Int32) -> Pogoprotos.Data.PokemonData.Builder {
        self.pokeball = value
        return self
      }
      ...
      public func setAdditionalCpMultiplier(_ value:Int32) -> Pogoprotos.Data.PokemonData.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.PokemonData) throws -> Pogoprotos.Data.PokemonData.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.PokemonData.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.PokemonData.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.PokemonData.Builder {
        ...
        if let jsonValueDeployedFortId = jsonMap["deployedFortId"] as? NSNumber {
          resultDecodedBuilder.deployedFortId = jsonValueDeployedFortId.int32Value
        }
        ...
        if let jsonValueAdditionalCpMultiplier = jsonMap["additionalCpMultiplier"] as? NSNumber {
          resultDecodedBuilder.additionalCpMultiplier = jsonValueAdditionalCpMultiplier.int32Value
        }
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.PokemonData.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
