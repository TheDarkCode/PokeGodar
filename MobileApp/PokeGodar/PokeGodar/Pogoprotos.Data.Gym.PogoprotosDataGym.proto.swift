...
public extension Pogoprotos.Data.Gym {
  ...
  final public class GymMembership : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Gym.GymMembership> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Gym.GymMembership? {
      return try Pogoprotos.Data.Gym.GymMembership.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Gym.GymMembership {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymMembership {
      return try Pogoprotos.Data.Gym.GymMembership.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Gym.GymMembership {
      return try Pogoprotos.Data.Gym.GymMembership.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymMembership {
    ...
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Gym.GymMembership {
      return try Pogoprotos.Data.Gym.GymMembership.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymMembership {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Gym.GymMembership) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Gym.GymMembership {
      return try Pogoprotos.Data.Gym.GymMembership.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Gym.GymMembership {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergePokemonData(_ value:Pogoprotos.Data.PokemonData) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
      ...
      public func mergeTrainerPublicProfile(_ value:Pogoprotos.Data.Player.PlayerPublicProfile) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Gym.GymMembership) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
  ...
  final public class GymState : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(_ input:InputStream) throws -> Array<Pogoprotos.Data.Gym.GymState> {
    ...
    public class func parseFromDelimitedFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Gym.GymState? {
      return try Pogoprotos.Data.Gym.GymState.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(_ data:Data) throws -> Pogoprotos.Data.Gym.GymState {
    ...
    public class func parseFromData(_ data:Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymState {
      return try Pogoprotos.Data.Gym.GymState.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(_ input:InputStream) throws -> Pogoprotos.Data.Gym.GymState {
      return try Pogoprotos.Data.Gym.GymState.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(_ input:InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymState {
      return try Pogoprotos.Data.Gym.GymState.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Gym.GymState {
      return try Pogoprotos.Data.Gym.GymState.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymState {
    ...
    public class func builderWithPrototype(_ prototype:Pogoprotos.Data.Gym.GymState) throws -> Pogoprotos.Data.Gym.GymState.Builder {
    ...
    override class public func decode(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Gym.GymState {
      return try Pogoprotos.Data.Gym.GymState.Builder.decodeToBuilder(jsonMap).build()
    }
    override class public func fromJSON(_ data:Data) throws -> Pogoprotos.Data.Gym.GymState {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func mergeFortData(_ value:Pogoprotos.Map.Fort.FortData) throws -> Pogoprotos.Data.Gym.GymState.Builder {
      ...
      public func mergeFrom(_ other:Pogoprotos.Data.Gym.GymState) throws -> Pogoprotos.Data.Gym.GymState.Builder {
      ...
      override public func mergeFromCodedInputStream(_ input:CodedInputStream) throws -> Pogoprotos.Data.Gym.GymState.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      override public func mergeFromCodedInputStream(_ input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymState.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let protobufTag = try input.readTag()
          switch protobufTag {
      ...
      override class public func decodeToBuilder(_ jsonMap:Dictionary<String,AnyObject>) throws -> Pogoprotos.Data.Gym.GymState.Builder {
      ...
      override class public func fromJSONToBuilder(_ data:Data) throws -> Pogoprotos.Data.Gym.GymState.Builder {
        let jsonData = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,AnyObject> else {
          throw ProtocolBuffersError.InvalidProtocolBuffer("Invalid JSON data")
        }
