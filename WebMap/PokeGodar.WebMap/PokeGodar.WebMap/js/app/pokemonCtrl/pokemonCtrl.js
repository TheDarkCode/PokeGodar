angular.module('pokemonCtrl', ['mapping', 'html', 'userInput'])
          ...
          /**
           * Controller for pokemon search form
           */
          .controller('pokemonSearchForm', function ($scope, $location, $window, suggest, cancelInput) {
              // execute search
              ...
              $scope.suggest = function () {
                  ...
                  var suggestResult = suggest('pokemon', {
                      search: $scope.model.query.q,
                      $select: 'city,state,zip,count',
                      $orderby: 'count desc',
                      suggesterName: 'pokemon-sg',
           ...
           */
          .controller('pokemonSort', function ($scope, $location) {
          ...
          .controller('pokemonFacets', function ($scope, $location, $filter, facetUrl, formatFilter) {
              ...
              $scope.filter = {};
              $scope.facetType = { rarity: 'Edm.String', pokemonType: 'Edm.String' };
              $scope.buckets = {};
          ...
          /**
           * Controller for main pokemon route
           */
          .controller('pokemonRoute', function ($scope, $location, $sce, currentLocation, search, bestView, groupFilters) {
              ...
              $scope.refreshResults = function () {
                  ...
                  if (_.startsWith($scope.model.query.order, 'location')) {
                      ...
                      result.$promise = result.$promise.then(function (loc) {
                          ...
                          return search('pokemon', searchParams).$promise;
                      });
                  } else {
                      result = search('pokemon', searchParams);
                  }
                  ...
                  result.$promise.then(function (data) {
                      ...
                      data.value.forEach(function (d, i) {
                          ...
                          d['@map.pin'] = new Microsoft.Maps.Pushpin(d['@map.location'], {
                              htmlContent: '<span class="map-pin"></span>', /* This is where you change the Pin */
           ...
           */
            .config(function ($routeProvider) {
                $routeProvider.when('/pokemon', {
                    ...
                    templateUrl: '/js/app/pokemonCtrl/pokemon.html',
